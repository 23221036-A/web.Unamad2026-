...
export default function ProductList({ onEdit }) {
    ...
    if(loading) return <p className="text-center text-xl mt-10">Cargando catálogo</p>
        ...
        <div className="p-6 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {products.map((product) => (
                    <div key={product.id} className="bg-white p-4 rounded-xl shadow-md border border-gray-100 flex flex-col justify-between">
                        <div>
                            <img src={product.imagen || 'https://via.placeholder.com/150'} alt={product.nombre} className="w-full h-48 object-cover rounded-lg mb-4" />
